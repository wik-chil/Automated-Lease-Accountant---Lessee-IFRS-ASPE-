...
lessee_engine.py file contains the "lessee engine" class, which processes, standardizes, measures and generates initial and subseuqent accounting-ready entries.
